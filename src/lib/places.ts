...
const ur: PlaceDict = {
  ...
  "Paradise": "پیراڈائز", "RTC X Roads": "آر ٹی سی ایکس روڈز",
  "Afzalgunj": "افضل گنج", "Mehdipatnam": "مہدی پٹنم",
  "Lakdikapul": "لکڑی کا پل", "Khairatabad": "خیرت آباد",
  "Patancheru": "پاتان چیرو", "Lingampally": "لنگم پلی",
  "Uppal": "اپل", "Tarnaka": "تارناکا",
  "Anand Vihar ISBT": "آنند وہار آئی ایس بی ٹی",
  "Akshardham": "اکشردھام", "Nizamuddin": "نظام الدین",
  "Greater Kailash": "گریٹر کیلاش", "Mehrauli": "مہرولی",
  "Mori Gate": "موری گیٹ", "Tis Hazari": "تیس ہزاری",
  "Punjabi Bagh": "پنجابی باغ", "Uttam Nagar": "اتم نگر",
  "Najafgarh": "نجف گڑھ", "INA": "آئی این اے",
  "Okhla": "اوکھلا", "Badarpur": "بدر پور",
  "Sarai Kale Khan": "سرائے کالے خان", "Azadpur": "آزاد پور",
  "CST": "سی ایس ٹی", "Sion": "سیون", "Vashi": "واشی",
  "Wadala": "وڈالہ", "Thane Stn": "تھانے اسٹیشن",
  "Banashankari": "بنشنکری", "Koramangala": "کورمنگلا",
  "Velachery": "ویلاچیری", "Pimpri": "پمپری",
  "Naroda": "نروڈا", "Kankaria": "کانکریا",
};
